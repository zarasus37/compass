...
export const CARD_CATALOG: CardMeta[] = [
  {
    ...
    defaultOn: true,
    description:
      "Your safe-to-spend number, today's pace, and the 7-day average. Tap to see the full transaction record.",
  },
  {
    id: "critical-timeline",
    eyebrow: "Coming up",
    title: "Critical Timeline",
    em: "the next few bills.",
    glyph: "⏱",
    accent: "warn",
    href: "/recurring",
    span: "half",
