 ...
 *
 * Moved from /settings/habit-quiz → /learn/habit-quiz per the
 * Cluster 4.0 site restructure. The quiz is part of the Learn
 * chapter (coaching, not configuration). The 308 redirect in
 * next.config.ts keeps the old URL working as a deep link.
 *
